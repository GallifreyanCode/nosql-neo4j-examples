package be.gallifreyan.neo4j.server.rest;
...
public class BatchCommandBuilder {
	...
	public BatchCommandBuilder createNode(int jobId,
	...
	public BatchCommandBuilder createRelationship(int jobId,
			String startNodeRelationshipUri, String endNodeUri, String relType,
			Map<String, String> dataParams) {
		return formatCreateRelationship(startNodeRelationshipUri, endNodeUri,
				relType, dataParams, jobId);
	}

	public BatchCommandBuilder createRelationship(
			String startNodeRelationshipUri, String endNodeUri, String relType) {
		return formatCreateRelationship(startNodeRelationshipUri, endNodeUri,
				relType, null, null);
	}
	...
	private BatchCommandBuilder formatCreateNode(
			Map<String, String> bodyParams, Integer jobId) {
		commands.add(String.format(CreateNodeTemplate,
				formatParams(bodyParams), formatJobId(jobId)));
		return this;
	}

	private BatchCommandBuilder formatCreateRelationship(
			String startNodeRelationshipUri, String endNodeUri, String relType,
			Map<String, String> dataParams, Integer jobId) {
		commands.add(String.format(CreateRelationshipTemplate,
				startNodeRelationshipUri, endNodeUri, relType,
