...
public class ServerTestUtils {
	public static final GraphDatabaseFactory EMBEDDED_GRAPH_DATABASE_FACTORY = new GraphDatabaseFactory() {
		...
		public AbstractGraphDatabase createDatabase(
	...
	public static void writePropertiesToFile(String outerPropertyName,
			Map<String, String> properties, File propertyFile) {
		writePropertyToFile(outerPropertyName, asOneLine(properties),
				propertyFile);
	}
	...
	public static File createTempPropertyFile(File parentDir)
			throws IOException {
		return new File(parentDir, "test-" + new Random().nextInt()
				+ ".properties");
	}
}
